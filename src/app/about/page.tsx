...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "emmanuelowouko@gmail",
    href: "mailto:emmanuelowouko@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/emmanuelowouko/",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Emmanuel Owouko</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Emmanuel, a Fullstack developer passionate about
